...
@click.option(
    ...
    help="Choose whether to run deployment, inference(prediction), or both."
    "Default is deploy and predict."
)
@click.option(
    "--min-acc",
    default=0.9,
    help="Minimum accuracy threshold for triggering the deployment pipeline.",
)
def main(config: str, min_acc: float) -> None:
